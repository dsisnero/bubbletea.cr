...
require "../../examples/vanish"

private def capture_vanish_output : Bytes
...
describe "examples/vanish parity" do
  it "matches the saved Go golden output exactly" do
    actual = capture_vanish_output
    expected = File.read("#{__DIR__}/golden/vanish.go.golden").to_slice
