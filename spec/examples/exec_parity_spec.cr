...
private def capture_exec_output : Bytes
...
describe "examples/exec parity" do
  it "matches the saved Go golden output exactly" do
    actual = capture_exec_output
    expected = File.read("#{__DIR__}/golden/exec.go.golden").to_slice
