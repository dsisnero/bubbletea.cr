...
require "../../examples/window_size"

private def capture_window_size_output : Bytes
...
describe "examples/window_size parity" do
  it "matches the saved Go golden output exactly" do
    actual = capture_window_size_output
    expected = File.read("#{__DIR__}/golden/window_size.go.golden").to_slice
