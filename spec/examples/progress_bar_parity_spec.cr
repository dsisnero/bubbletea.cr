...
private def capture_progress_bar_output : Bytes
...
describe "examples/progress_bar parity" do
  it "matches the saved Go golden output exactly" do
    actual = capture_progress_bar_output
    expected = File.read("#{__DIR__}/golden/progress_bar.go.golden").to_slice
