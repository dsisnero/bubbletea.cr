...
require "../../examples/suspend"

private def capture_suspend_output : Bytes
...
describe "examples/suspend parity" do
  it "matches the saved Go golden output exactly" do
    actual = capture_suspend_output
    expected = File.read("#{__DIR__}/golden/suspend.go.golden").to_slice
