...
private def capture_simple_output : Bytes
...
describe "examples/simple parity" do
  it "matches the saved Go golden output exactly" do
    actual = capture_simple_output
    expected = File.read("#{__DIR__}/golden/simple.go.golden").to_slice
