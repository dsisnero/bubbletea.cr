...
private def capture_capability_output : Bytes
...
describe "examples/capability parity" do
  it "matches the saved Go golden output exactly" do
    actual = capture_capability_output
    expected = File.read("#{__DIR__}/golden/capability.go.golden").to_slice
