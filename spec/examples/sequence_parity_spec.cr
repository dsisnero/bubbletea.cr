...
require "../../examples/sequence"

private def capture_sequence_output : Bytes
...
describe "examples/sequence parity" do
  it "matches the saved Go golden output exactly" do
    actual = capture_sequence_output
    expected = File.read("#{__DIR__}/golden/sequence.go.golden").to_slice
